      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.descriptionBox}>
            <Text style={styles.descriptionText}>
              High-precision stimulus response tracking to measure processing
              speed and cognitive performance.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            } else if (gameName === "Walk and Turn") {
              router.push("/(tabs)/(games)/WalkAndTurn/WalkAndTurn");
            }
          }}
        >
